...
public class CategoryServiceImpl implements CategoryService {
  ...
  /*  @Override
    ...
    public Page<Category> findPaginated(Pageable pageable) {
        ...
        //using repo method returning paginated data
    }
    ...
    // by taking the specific id implementing the operations on it
    @Override
    public Category findById(Long category_id) {

        Optional<Category> optional = repo.findById(category_id);
    ...
    public void deleteById(Long category_id) {
        ...
        this.repo.deleteById(category_id);
    }
